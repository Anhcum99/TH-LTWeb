                        ...
                        <div class="product-select-box">
                            <div class="product-short">
                                ...
                                <select class="nice-select">
                                    <option value="trending">Dưới 10 triệu</option>
                                    <option value="sales">Từ 10 đến 15 triệu</option>
                                    <option value="sales">Từ 15 đến 20 triệu</option>
                                    <option value="rating">Từ 20 đến 25 triệu</option>
                                    <option value="date">Trên 25 triệu</option>
                                </select>
                            </div>
                        </div>
